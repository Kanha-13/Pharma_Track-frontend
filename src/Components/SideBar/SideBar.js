...
const SideBar = ({ current, onswitch }) => {
  ...
  return (
    <div style={{ height: "100%", width: "15%", borderRight: "1px solid gray", display: "flex", alignItems: "center", flexDirection: "column" }}>
      <button onClick={() => onswitch("")} style={{ textAlign: "centre", fontSize: "1rem", color: "#ffffff", width: "80%", height: "5vh", cursor: "pointer", margin: "40px 0px 30px 0px", border: "none", backgroundColor: "#5E48E8", borderRadius: "0.2rem" }}> + Quick Add</button>
