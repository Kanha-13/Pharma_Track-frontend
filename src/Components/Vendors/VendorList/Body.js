...
const Body = ({ onclick, vendors = [] }) => {
  return (
    <div style={{ width: "100%", height: "90%", display: "flex", flexDirection: "column", overflow: "auto" }}>
      <div style={{ paddingLeft: "5px", display: "flex", backgroundColor: "#D6D8E7", flexDirection: "row", width: "99%", justifyContent: "space-between", }}>
      ...
      </div>
      {
        vendors.map((vendor) => {
          return (
            <div onClick={onclick} style={{ paddingLeft: "5px", cursor: "pointer", borderBottom: "1px solid #D6D8E7", display: "flex", flexDirection: "row", width: "99%", justifyContent: "space-between", }}>
