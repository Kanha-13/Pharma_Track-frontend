        ...
        purchaseProducts.map((item, index) => {
          ...
          return (
            <div id="purchase-data-container" onClick={() => { }} key={`${item?._id}-purchase-list-${index}`} className="purchase-batch-row" style={{ height: "5vh", margin: "2vh 0px", width: "100%", display: "flex", justifyContent: "space-between" }}>
              <Card require={true} value={purchaseProducts[index]?.pId} w="14%" h="35%" pd="1.3vh 0.1vw" m="0px" name={PURCHASEPRODUCTINFO.PRODUCTID} label="" onchange={onchangeProductDetail} type="select" options={products} />
              <Card require={true} value={purchaseProducts[index]?.pkg} w="5%" h="35%" pd="1.3vh 0.1vw" m="0px" ph="pkg" name={PURCHASEPRODUCTINFO.PKG} label="" onchange={onchangeProductDetail} type="text" />
              <Card require={true} value={purchaseProducts[index]?.qnty} w="4.5%" h="35%" pd="1.3vh 0.1vw" m="0px" label="" ph="Qnty" name={PURCHASEPRODUCTINFO.QNT} onchange={onchangeProductDetail} type="number" />
              ...
              <Card require={true} value={purchaseProducts[index]?.batch} w="8%" h="35%" pd="1.3vh 0.1vw" m="0px" ph="Batch no." name={PURCHASEPRODUCTINFO.BATCH} label="" onchange={onchangeProductDetail} type="text" />
              <Card require={true} value={purchaseProducts[index]?.expDate} w="11%" h="35%" pd="1.3vh 0.1vw" m="0px" fs="0.9rem" name={PURCHASEPRODUCTINFO.EXPDATE} label="" onchange={onchangeProductDetail} type="month" />
              ...
              <Card require={true} value={purchaseProducts[index]?.netValue} w="6%" h="35%" pd="1.3vh 0.1vw" m="0px" ph="value" name={PURCHASEPRODUCTINFO.N_VALUE} label="" onchange={onchangeProductDetail} type="text" />
              ...
              <Card require={true} value={purchaseProducts[index]?.netAmt} w="6%" h="35%" pd="1.3vh 0.1vw" m="0px" ph="net amt" name={PURCHASEPRODUCTINFO.N_AMT} label="" onchange={onchangeProductDetail} type="text" />
