  ...
  return (
    <div className="login-child-container">
      ...
      <div className="left">
        ...
        <input placeholder='example@example.com' autoFocus type='email' style={{ padding: "0px 2%", fontSize: "1.1rem", margin: "5px 0px", height: "5%", width: "57%", border: "1px solid #D6D8E7", borderRadius: "0.2rem", fontSize: "1.2rem" }} value={email} onChange={(e) => setEmail(e.target.value)} />
        <p style={{ margin: "10px 0px 5px 0px", width: "60%", textAlign: "left", fontSize: "0.9rem" }}>Password</p>
        <input placeholder="***********" autoFocus type='password' style={{ padding: "0px 2%", fontSize: "1.1rem", margin: "5px 0px", height: "5%", width: "57%", border: "1px solid #D6D8E7", borderRadius: "0.2rem", fontSize: "1.2rem" }} value={password} onChange={(e) => setPassword(e.target.value)} />
        <p style={{ margin: "5px 0px", width: "60%", textAlign: "left", fontSize: "0.9rem" }}>Role</p>
        <input placeholder='Assistant' autoFocus type='email' style={{ padding: "0px 2%", fontSize: "1.1rem", margin: "5px 0px", height: "5%", width: "57%", border: "1px solid #D6D8E7", borderRadius: "0.2rem", fontSize: "1.2rem" }} value={role} onChange={(e) => setRole(e.target.value)} />
